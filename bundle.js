...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchBar = __webpack_require__(187);

	var _searchBar2 = _interopRequireDefault(_searchBar);

	var _videoList = __webpack_require__(188);

	var _videoList2 = _interopRequireDefault(_videoList);

	var _videoDetail = __webpack_require__(190);
	...
	var API_KEY = 'api_key=7f8b12c3414a19408dd8afa2b9943502';
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.onClickSearch = _this.onClickSearch.bind(_this);
	    _this.setRecommendation = _this.setRecommendation.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function initMovies() {
	      _axios2.default.get('' + API_END_POINT + POPULAR_MOVIES_URL + '&' + API_KEY).then(function (response) {
	        this.setState({
	    ...
	    value: function onClickSearch(searchText) {
	      if (searchText) {
	        _axios2.default.get('' + API_END_POINT + SEARCH_URL + '&' + API_KEY + '&query=' + searchText).then(function (response) {
	    ...
	    value: function setRecommendation() {
	      _axios2.default.get(API_END_POINT + 'movie/' + this.state.currentMovie.id + '/recommendations?&' + API_KEY + '&language=fr').then(function (response) {
	        this.setState({
	          moviesList: response.data.results.slice(0, 5)
	        });
	      }.bind(this));
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var renderVideoList = function renderVideoList() {
	        if (_this2.state.moviesList.length >= 3) {
	          return _react2.default.createElement(_videoList2.default, { movieList: _this2.state.moviesList, callback: _this2.onClickListItem });
	        }
	      };
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_searchBar2.default, { callback: this.onClickSearch })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'row' },
	          _react2.default.createElement(
	            'div',
	            { className: 'col-md-8' },
	            _react2.default.createElement(_video2.default, { videoId: this.state.currentMovie.videoId }),
	            _react2.default.createElement(_videoDetail2.default, { title: this.state.currentMovie.title, description: this.state.currentMovie.overview })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-md-4' },
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-md-8 input-group' },
	          _react2.default.createElement('input', { type: 'text', className: 'form-control input-lg', onChange: this.handleChange, placeholder: this.state.placeHolder }),
	          _react2.default.createElement(
	            'span',
	            { className: 'input-group-button' },
	            _react2.default.createElement(
	              'button',
	              { className: 'btn btn-secondary', onClick: this.handleOnClick },
	              'GO'
	            )
	          )
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _videoListItem = __webpack_require__(189);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      movieList.map(function (movie) {
	        return _react2.default.createElement(_videoListItem2.default, { key: movie.id, movie: movie, callback: receiveCallBack });
	      })
	    )
	  );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var VideoListItem = function VideoListItem(props) {
	  ...
	  return _react2.default.createElement(
	    'li',
	    { className: 'list-group-item', onClick: handleOnClick },
	    _react2.default.createElement(
	      'div',
	      { className: 'media' },
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { className: 'media-object img-rounded', width: '100px', src: '' + IMAGE_BASE_URL + movie.poster_path })
	      ),
	      _react2.default.createElement(
	        'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Video = function Video(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement('iframe', { className: 'embed-responsive-item', src: '' + BASE_URL + videoId })
	  );
	};
